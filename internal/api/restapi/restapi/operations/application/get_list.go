...
type GetListHandlerFunc func(GetListParams) GetListResponder

// Handle executing the request and returning a response
func (fn GetListHandlerFunc) Handle(params GetListParams) GetListResponder {
	return fn(params)
}

// GetListHandler interface for that can handle valid get list params
type GetListHandler interface {
	Handle(GetListParams) GetListResponder
}
...
/*
	GetList swagger:route GET /application Application getList
